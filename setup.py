...
setup(
    ...
    description="Print high-resolution MtG proxies.",  # Optional
    ...
    url="https://github.com/DiddiZ/mtg-proxies",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Robin Kupper",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="robin.kupper@rwth-aachen.de",  # Optional
    ...
    keywords="pdf proxies mtg magic-the-gathering mtg-cards scryfall decklist",  # Optional
    ...
    install_requires=["numpy", "matplotlib", "requests", "tqdm"],  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/DiddiZ/mtg-proxies/issues",
        "Source": "https://github.com/DiddiZ/mtg-proxies",
    },
)
